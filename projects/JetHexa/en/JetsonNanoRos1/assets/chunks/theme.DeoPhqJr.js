const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.BB43OBi8.js","assets/chunks/framework.BX7ESlkk.js"])))=>i.map(i=>d[i]);
...
const _sfc_main$n = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.BB43OBi8.js"), true ? __vite__mapDeps([0,1]) : void 0));
