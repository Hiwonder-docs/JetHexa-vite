...
function pathToFile(path) {
  ...
  {
    if (inBrowser) {
      const base = "/projects/JetHexa/en/JetsonNanoRos1/";
...
const assetsURL = function(dep) {
  return "/projects/JetHexa/en/JetsonNanoRos1/" + dep;
};
const seen = {};
...
export {
  ...
  tryOnScopeDispose as al,
  toValue as am,
  toArray as an,
  unrefElement as ao,
  notNullish as ap,
  computedAsync as aq,
  useSessionStorage as ar,
  useLocalStorage as as,
  watchDebounced as at,
  useRouter as au,
