const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.5IeDy_4d.js","assets/chunks/framework.CrxDo7ed.js"])))=>i.map(i=>d[i]);
...
const _sfc_main$n = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.5IeDy_4d.js"), true ? __vite__mapDeps([0,1]) : void 0));
